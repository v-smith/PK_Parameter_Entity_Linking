...
def main(
        ...
        model_name: str = typer.Option(default="/home/vsmith/PycharmProjects/PKEntityLinker/trained_models/trial_5_epochs_ireval_earlystop_weightdecay_hardneg_context/checkpoint-800"),
        text_feature: str = typer.Option(default='text_with_tagged_mention', help="Options are mention, text_with_tagged_mention, mention_with_window."),
        ...
        match_threshold: float = typer.Option(default=0.70, help="Match threshold"),
        category_constraint: bool = typer.Option(default=True),
        include_ontology_desc: bool = typer.Option(True),
